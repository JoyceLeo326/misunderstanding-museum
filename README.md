...
- GitHub Pages：<https://joyceleo326.github.io/misunderstanding-museum/>
...
- 可回填真实对话结果：更理解、仍没说清、需要空间或需要更具体，都会改变下一轮首件藏品、建议下一句与复盘重点；
...
- “只看字面 / 补上语境”双态互动展签；
- 四层语境观察：原话、字面、语境、下一句；
- 本地藏品卡制作器：实时预览、复制、Markdown 下载与草稿恢复；
...
- `v5.0 · 2026-08`：把事件录入、多视角解析、三条方案对照、人工确认、沟通档案下载与真实反馈回流连成一个连续工作台；候选顺序与 24 张故事图由关系、目标、所在视角和反馈共同驱动，并补齐严格的 44px 触控与小屏输入安全区。
