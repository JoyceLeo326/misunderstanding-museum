...
误会博物馆从这样的时刻开始，但不只停在观看。你可以写下具体事件，从表达者、接收者与共同关系三种视角看见缺口，比较三条带取舍的沟通路径；由你确认后，下载一份能继续修改和复盘的沟通档案。
...
第一次打开时，可以直接进入“我的路线”，用默认案例看完三条候选路径、确认其中一条并下载沟通档案；也可以先看首件藏品，理解“字面 → 语境 → 下一句”的方法，再把自己的事件带进和解工作台。不要急着下载：先读完三条路径的代价，再选择真正愿意承担的沟通方式。
